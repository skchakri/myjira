Rails.application.routes.draw do
  ...
  scope "projects/:project_id" do
    ...
    post  "board/items/:id/apply_triage",   to: "boards#apply_triage_suggestion",  as: :board_item_apply_triage
    post  "board/items/:id/dismiss_triage", to: "boards#dismiss_triage_suggestion", as: :board_item_dismiss_triage
